...
<div class="container-fluid p-0">
  ...
  <div class="sidebar-navigation admin-bg p-0  col-sm-2 ">
    ...
    <ul class="nav nav_main">
      ...
      <li class= "nav-item col-12 "><a class="nav-link" href="dashboard.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="posts.php"><i class="fas fa-file"></i> Posts</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="pages.php"><i class="fas fa-book-open"></i> Pages</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="categories.php"><i class="fas fa-list"></i> Categories</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="products.php"><i class="fas fa-box"></i> Products</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="customers.php"><i class="fas fa-users"></i> Customers</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="tables.php"><i class="fas fa-table"></i> Tables</a></li>
      <li class= "nav-item col-12"><a class="nav-link" href="charts.php"><i class="fas fa-chart-line"></i> Charts</a></li>
...
<div class="content p-0 col-sm-10">
  <div class="top-navigation ">
    ...
    <ul class="nav nav_main justify-content-end pr-3 admin-bg">
